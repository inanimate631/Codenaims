...
const corsOptions = {
  origin: "https://codenames-for-mavzolei.netlify.app", // Разрешенный источник (origin)
...
const io = socketIO(server, {
  cors: {
    origin: "https://codenames-for-mavzolei.netlify.app",
    methods: ["GET", "POST"],
  },
});
...
app.use((req, res, next) => {
  res.setHeader("Access-Control-Allow-Origin", "https://codenames-for-mavzolei.netlify.app");
